...
classDirectory=ToFileName[JavaKhDirectory,"bin"];classpath=StringJoin[(*this is a horrible hack to make sure the classpath works on both unix and windows systems*)classDirectory,":",ToFileName[jarDirectory,"commons-cli-1.0.jar"],":",ToFileName[jarDirectory,"commons-io-1.2.jar"],":",ToFileName[jarDirectory,"commons-logging-1.1.jar"],":",ToFileName[jarDirectory,"log4j-1.2.12.jar"],":",ToFileName[jarDirectory,"trove-2.0.4.jar"],":;",classDirectory,";",ToFileName[jarDirectory,"commons-cli-1.0.jar"],";",ToFileName[jarDirectory,"commons-io-1.2.jar"],";",ToFileName[jarDirectory,"commons-logging-1.1.jar"],";",ToFileName[jarDirectory,"log4j-1.2.12.jar"],";",ToFileName[jarDirectory,"trove-2.0.4.jar"]];cl=StringJoin["!java -classpath \"",classpath,"\" "," org.katlas.JavaKh.JavaKh -U < pd"];
f=OpenRead[cl];
